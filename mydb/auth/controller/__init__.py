...
from mydb.auth.controller.advertisement.advertisement_controller import (
...
from mydb.auth.controller.car_dealership.car_dealership_addresses_controller import (
    CarDealershipAddressesController,
)
from mydb.auth.controller.car_dealership.car_dealership_seller_controller import (
    CarDealershipSellerController,
)
from mydb.auth.controller.car_dealership.car_dealership_controller import (
    CarDealershipController,
)
from mydb.auth.controller.car_dealership.user_car_dealership_controller import (
    UserCarDealershipController,
)
...
car_dealership_addresses_controller = CarDealershipAddressesController()
