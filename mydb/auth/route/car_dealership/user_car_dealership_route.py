...
user_car_dealership_bp = Blueprint(
    "user_car_dealerships", __name__, url_prefix="/user_car_dealerships/"
)
...
def get_all_user_car_dealerships() -> Response:
    return make_response(
        jsonify(user_car_dealership_controller.find_all()), HTTPStatus.OK
    )
...
def get_user_car_dealerships(user_car_dealership_id: int) -> Response:
    return make_response(
        jsonify(user_car_dealership_controller.find_by_id(user_car_dealership_id)),
        HTTPStatus.OK,
    )
...
def create_user_car_dealership() -> Response:
    ...
    return make_response(
        f"UserCarDealership created with ID: {user_car_dealership_id}",
        HTTPStatus.CREATED,
    )
...
def user_car_dealerships():
    return make_response(
        jsonify(user_car_dealership_controller.user_car_dealerships()), HTTPStatus.OK
    )
...
def car_dealerships_user():
    return make_response(
        jsonify(user_car_dealership_controller.car_dealerships_user()), HTTPStatus.OK
    )


@user_car_dealership_bp.post("/create_with_names/<string:user_name>/<string:car_dealership_name>")
def insert_user_car_dealership(user_name: str, car_dealership_name: str):
    user_car_dealership_controller.insert_user_car_dealership(user_name, car_dealership_name)
    return "SUCCESS"
