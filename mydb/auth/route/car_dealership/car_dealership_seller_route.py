...
car_dealership_seller_bp = Blueprint(
    "car_dealership_sellers", __name__, url_prefix="/car_dealership_sellers/"
)
...
def get_all_car_dealership_sellers() -> Response:
    return make_response(
        jsonify(car_dealership_seller_controller.find_all()), HTTPStatus.OK
    )
...
def get_car_dealership_sellers(car_dealership_seller_id: int) -> Response:
    return make_response(
        jsonify(car_dealership_seller_controller.find_by_id(car_dealership_seller_id)),
        HTTPStatus.OK,
    )
...
def update_car_dealership_seller(car_dealership_seller_id: int) -> Response:
    ...
    car_dealership_seller_controller.update(
        car_dealership_seller_id, car_dealership_seller
    )
...
def create_car_dealership_seller() -> Response:
    content = request.get_json()
    car_dealership_seller = CarDealershipSeller.create_from_dto(content)
    car_dealership_seller_id = car_dealership_seller_controller.create(
        car_dealership_seller
    )
    return make_response(
        f"CarDealershipSeller created with ID: {car_dealership_seller_id}",
        HTTPStatus.CREATED,
    )
...
def create_all_car_dealership_sellers() -> Response:
    content = request.get_json()
    car_dealership_sellers = [
        CarDealershipSeller.create_from_dto(data) for data in content
    ]
...
def seller_car_dealerships():
    return make_response(
        jsonify(car_dealership_seller_controller.seller_car_dealerships()),
        HTTPStatus.OK,
    )
...
def car_dealerships_seller():
    return make_response(
        jsonify(car_dealership_seller_controller.car_dealerships_seller()),
        HTTPStatus.OK,
    )
