...
def create_test_drive() -> Response:
    ...
    return make_response(f"TestDrive created with ID: {test_drive_id}", HTTPStatus.CREATED)
...
def create_all_test_drives() -> Response:
    ...
    return make_response(test_drive_controller.create_all(test_drives), HTTPStatus.CREATED)
