...
from mydb.auth.dao import car_dealership_seller_dao, seller_dao, user_dao, car_dealership_dao
        ...
        for car_dealership_seller in car_dealership_sellers:
            ...
            if car_dealership_id not in result:
                ...
                result[car_dealership_id] = {
                    car_dealership.name:
                        seller_dao.find_by_id(obj.seller_user_id).put_into_dto() for obj in car_dealership.sellers
                }
        return list(result.values())
